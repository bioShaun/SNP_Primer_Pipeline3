...
class PolymarkerParser:
            ...
            with open(input_file, encoding="utf-8") as f:
                ...
                for raw_line in f:
                    ...
                    raise ParseError(
                        ...
                        "  - Polymarker (CSV/Space/Tab): SNP_ID Chromosome Sequence[A/G]Sequence\n"
                        "  - Coordinates (CSV/Space/Tab): Chromosome Position Ref Alt"
                    )
        except OSError as e:
    ...
    def to_fasta(self, output_file: Path) -> Path:
        ...
        try:
            ...
            raise ParseError(f"Failed to write FASTA file: {e}") from e
    ...
    def parse_coordinates(self, reference: Path) -> list[SNP]:
        ...
        for coord in self._coordinates:
            ...
            # Convert to IUPAC at position 50 (center of 101bp sequence)
    ...
    def fetch_target_flanking(self, reference: Path, flanking_size: int = 500):
        ...
        logger.info(
            f"Directly extracting ±{flanking_size}bp target flanking from known coordinates..."
        )
